...
def renombrador(archivo):
    ...
    stream = chat(
        model=modelo,
        messages=[{'role': 'user',
                   'content': f'Propón un único nombre técnico y estructurado para titular un archivo PDF académico, basado en el siguiente extracto: {text}. El nombre debe ser claro, conciso y específico, similar a “Clase 1.1 Cálculo Multivariable”. Usa un estilo formal, ordenado y orientado a cursos o documentos académicos. No incluyas explicaciones ni comillas. Entrega solo el nombre, en una línea. No seas estupido, no cometas errores'}],
        stream=True,
    )
...
print(seleccion("/Users/svaldes/Desktop/Universidad/2025-1/MAT203 Cálculo Multivariables/Clases/Clase 22 rotacional y divergencia.pdf"))
